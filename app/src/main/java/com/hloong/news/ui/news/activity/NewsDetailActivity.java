...
import com.hloong.news.ui.news.model.NewsDetailModel;
import com.hloong.news.ui.news.presenter.NewsDetailPresenter;
...
public class NewsDetailActivity extends BaseActivity<NewsDetailPresenter,NewsDetailModel> implements NewsDetailContract.View {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        mPresenter.getNewsDetailDataRequest(postId);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_web_view:
                        NewsWebActivity.startAction(NewsDetailActivity.this, mShareLink, mNewsTitle);
                        break;
    ...
    private void setNewsDetailPhotoIv(String imgSrc) {
        ImageLoader.display(this,newsDetailPhotoIv,imgSrc);
    }
