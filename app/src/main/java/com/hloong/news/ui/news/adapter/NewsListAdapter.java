...
import com.hloong.news.ui.news.activity.NewsDetailActivity;
import com.hloong.news.ui.news.activity.NewsPhotoDetailActivity;
    ...
    public void convert(ViewHolderHelper helper, NewsSummary newsSummary) {
        switch (helper.getLayoutId()) {
            case R.layout.item_news:
                setItemValues(helper, newsSummary, getPosition(helper));
                break;
            case R.layout.item_news_photo:
                setPhotoItemValues(helper, newsSummary, getPosition(helper));
                break;
        }
    }
