package com.hloong.news.ui.zone.viewholder;
...
import com.hloong.base.imagepager.BigImagePagerActivity;
...
import com.hloong.news.ui.zone.adapter.CircleAdapter;
import com.hloong.news.ui.zone.adapter.CommentAdapter;
import com.hloong.news.ui.zone.adapter.FavortListAdapter;
import com.hloong.news.ui.zone.bean.CircleItem;
import com.hloong.news.ui.zone.bean.CommentConfig;
import com.hloong.news.ui.zone.bean.CommentItem;
import com.hloong.news.ui.zone.bean.FavortItem;
import com.hloong.news.ui.zone.presenter.CircleZonePresenter;
import com.hloong.news.ui.zone.spannable.ISpanClick;
import com.hloong.news.ui.zone.widget.CommentDialog;
import com.hloong.news.ui.zone.widget.CommentListView;
import com.hloong.news.ui.zone.widget.ExpandableTextView;
import com.hloong.news.ui.zone.widget.FavortListView;
import com.hloong.news.ui.zone.widget.MultiImageView;
...
public class ZoneViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setData(CircleZonePresenter mPresenter2, CircleItem circleItem2, final int position2){
        ...
        //头像
        ImageLoader.displayRound(mContext, headIv, DatasUtil.getRandomPhotoUrl());
        ...
        switch (type) {
            case CircleAdapter.ITEM_VIEW_TYPE_URL:// 处理链接动态的链接内容和和图片
                ...
                ImageLoader.display(mContext, urlImageIv, linkImg);
